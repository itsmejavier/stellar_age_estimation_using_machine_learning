...
grid_search_MSS = GridSearchCV(estimator=knn_MSS,param_grid=param_grid,
...
best_knn_model_MSS = KNeighborsRegressor(**best_params_MSS)
best_knn_model_MSS.fit(X_MSS_train, y_MSS_train)

# Melakukan prediksi pada data pengujian
y_MSS_pred = best_knn_model_MSS.predict(X_MSS_test)
...
# Gunakan GridSearchCV untuk mencari hyperparameter terbaik
grid_search_RGS = GridSearchCV(estimator=knn_RGS,param_grid=param_grid,
                               cv=5,scoring='neg_mean_squared_error',verbose=1,n_jobs=-1)
...
# Latih ulang model dengan hyperparameter terbaik pada seluruh data pelatihan
best_knn_model_RGS = KNeighborsRegressor(**best_params_RGS)
best_knn_model_RGS.fit(X_RGS_train, y_RGS_train)

# Melakukan prediksi pada data pengujian
y_RGS_pred = best_knn_model_RGS.predict(X_RGS_test)
...
plt.title("Scatter Plot Umur Bintang\n Menggunakan KNN") # Beri judul scatter plot.
...
# Gunakan fungsi open().
modelMSS = 'C:\\Users\\ACER\\Downloads\\Tugas Akhir Astronomi\\Uji Coba KNN\\Version 1\\modelMSS.txt'

# Buka file di write mode
with open(modelMSS,'w') as file:
  # Write content to the file
  file.write(str(best_knn_model_MSS))

    
# Simpan model untuk Bintang Raksasa Merah.
# Gunakan fungsi open().
modelRGS = 'C:\\Users\\ACER\\Downloads\\Tugas Akhir Astronomi\\Uji Coba KNN\\Version 1\\modelRGS.txt'

# Buka file di write mode
with open(modelRGS,'w') as file:
  # Write content to the file
  file.write(str(best_knn_model_RGS))
...
# Simpan data.
df_y_MSS_diff_table.to_csv('C:\\Users\\ACER\\Downloads\\Tugas Akhir Astronomi\\Uji Coba KNN\\Version 1\\MainSequenceStars.csv')
df_y_RGS_diff_table.to_csv('C:\\Users\\ACER\\Downloads\\Tugas Akhir Astronomi\\Uji Coba KNN\\Version 1\\RedGiantStars.csv')
...
# Simpan data.
df_metric_MSS.to_csv('C:\\Users\\ACER\\Downloads\\Tugas Akhir Astronomi\\Uji Coba KNN\\Version 1\\Metric_MainSequenceStars.csv')
df_metric_RGS.to_csv('C:\\Users\\ACER\\Downloads\\Tugas Akhir Astronomi\\Uji Coba KNN\\Version 1\\Metric_RedGiantStars.csv')
